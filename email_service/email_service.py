...
def send_simple_message(to, subject, body):
    return requests.post(
        "https://api.mailgun.net/v3/sandbox1885d4dca98644c48977ad3aade3b7a4.mailgun.org/messages",
        auth=("api", "b8f131515500640abafd928061c41a85-c9270c97-7df193d3"),
        data={"from": "Mailgun Sandbox <postmaster@sandbox1885d4dca98644c48977ad3aade3b7a4.mailgun.org",
              "to": to,
              "subject": subject,
              "html": body})
